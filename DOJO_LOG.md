...
| struct-copy-semantics | 5 | unseen | – | – | – | opened for selection 2026-09-21 alongside methods; assignment and function calls copy the struct. Same rule as ch4 `pass-by-value`, which is still `unseen`. Seeds S10, S11 |
