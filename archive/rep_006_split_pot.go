...
func splitPot(pot, members int) (int, int) {
	...
	memberShare := pot / members
	kittyShare := pot % members
	return memberShare, kittyShare
}
...
/*
Verdict: pass, notes.
One nudge: zero-members branch returned values in parameter order instead of result order.
Corrected by Matt; output matches, gofmt and go vet clean. No idiom flags.
*/
