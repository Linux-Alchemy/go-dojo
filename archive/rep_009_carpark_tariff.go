...
- Output matched all five lines first run, no nudges.
- Boundary calls correct: 30 inclusive in grace, 120 in short, 480 in day.
- Tagless switch used as asked; returns ordered fee-then-band throughout.

FLAGS
1. gofmt dirty: stray second blank line after chargeFor's closing brace.
2. Redundant parens in `case minutes <= (60 * 2)` — `60*2` binds tighter than `<=` anyway.
*/
